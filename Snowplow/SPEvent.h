...
/*!
 @brief Set the class name for the view controller.

 @param viewControllerName The class name of the view controller responsible for the screen view event.
 */
- (void) setViewControllerName:(NSString *)viewControllerName;

/*!
 @brief Set the class name for the top view controller.

 @param viewControllerName The class name of the top view controller responsible for the screen view event.
 */
